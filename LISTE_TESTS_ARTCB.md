...
| T-E55 | `ARTCB_INGEST_PROMPT_FILE` + `POST /ai/memo` OVH1 + mesure stack HTTP/nginx | Prompt user_query gravé caractère-par-caractère (max 32000) ; thinking/tokens **pas** on-chain ; Cursor transcript ≠ ARTCB ; stack mesurée vs InfiniBand/QUIC | [ ] | 2026-09-08 en cours — rapport 267 |
