...
| T-E80 | `pytest tests/test_e2e306_p0_proof_matrix.py` + live `scripts/run_live306_p0_proof_matrix.py` | P0 : SHA×5 ; membership identity ; primary_of vs stored ; propose PREPARE ; tip seeds ; chaos SSH ; CERTIFIED_100=false | [x] | 2026-09-10T15:20:00Z pytest 5 passed. Live : SHA PARTIAL (AWS3 lag) ; primary FAIL_DIVERGENCE ; propose 409 equivocation/not_primary ; tip seeds 1133 PASS_SEEDS_ONLY ; Mac hors quorum ; SSH NOT_RUN ; CI statuses []. |
| T-E81 | `pytest tests/test_e2e307_p0_primary_repair.py` + live `scripts/run_live307_p0_primary_repair.py` | P0 repair : primary_of canonique ; VC/NV sans wipe ; SHA×5 ; PREPARE/COMMIT Q=3 seeds ; tip×5 Mac ; CERTIFIED_100=false | [x] | 2026-09-10T15:50:00Z. Live : VC 15→16→17 ; primary aligné aws-3 ; SHA 8acbbdee ×5 ; PREPARE/COMMIT 4/4 + writes ; height 1134 ; Mac tip FAIL ; chaos NOT_RUN. |
