...
| T-E40 | `pytest tests/test_e2e205_no_rescue_biometric.py tests/test_e2e208_biometric_cert_gate.py tests/test_webauthn_biometric.py` | WebAuthn D-055 ; gate lit RESULT.json ; GO false tant que DV-02/06 PARTIAL | [x] | 2026-09-02 3+4+5 passed |
