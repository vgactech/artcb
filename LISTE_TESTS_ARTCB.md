...
| T-E56 | `pytest tests/test_e2e268_agent_pbft.py` + live `scripts/run_live268_p8_prepared_vc.py` `scripts/run_live268_agent_protocol.py` | Prepared cert dans VC ; Y refusé ; agent bootstrap+idempotence ; SHA = origin/main ×4 | [ ] | 2026-09-08 en cours — R268 |
