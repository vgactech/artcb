...
| T-E58 | `pytest tests/test_e2e270_pbft_cert_matrix.py` + live `scripts/run_live270_pbft_cert_matrix.py` | Matrice certification PBFT ; CERTIFIED_100 interdit si une ligne critique NOT_PROVEN ; live WAN + fautes combinées ; SHA = origin/main ×4 | [ ] | 2026-09-08 en cours — R270 |
