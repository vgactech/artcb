...
| T-E72 | `pytest tests/test_e2e289_aep.py` + live `scripts/run_live289_aep.py` | AEP : R284 6 events PARTIAL exhaustive ; SSH FAIL + COMPLETE_FOR_PROFILE ; LOSSLESS no silent truncate ; thinking jamais ; Cursor runtime NOT_PROVEN ; CERTIFIED_100=false | [x] | 2026-09-09 pytest 12 passed. Live `AR-289-20260909T183729Z` SHA ×4 `05d7030` height 1133. 16 events. mac_ssh COMPLETE_FOR_PROFILE ; SSH FAIL ; exhaustive PARTIAL ; thinking_recorded false. CERTIFIED_100=false. |
| T-E73 | `pytest tests/test_e2e290_private_thinking.py tests/test_e2e289_aep.py` | thinking intégral → `visibility=private` ; chunks lossless ; public ≠ private ; Cursor hook thinking NOT_PROVEN si fichier absent | [x] | 2026-09-09 pytest PASS. Live thinking file **absent** (Cursor n'injecte pas) = NOT_PROVEN, pas un skip déguisé. CERTIFIED_100=false. |
| T-E74 | `pytest tests/test_e2e290_private_thinking.py tests/test_live_bootstrap_168.py` | mémos / think / agent events : **aucun** `maxLength` 32k ; ingest poste le texte entier ; `MEMO_CONTENT_MAX` révoqué ; pas de troncature silencieuse | [x] | 2026-09-09 pytest 16 passed. Live encore SHA `05d7030` = cap 32k jusqu’à follow-main. CERTIFIED_100=false. |
| T-E75 | `pytest tests/test_e2e292_thinking_states.py tests/test_e2e289_aep.py tests/test_e2e290_private_thinking.py` | AEP : 5 états thinking ; private ≠ CoT ; HTTP 200 ≠ integrity ; Cursor unset = NOT_PROVEN ; thinking_recorded alias strict | [x] | 2026-09-09 pytest 22 passed. Live SHA `05d7030`. CERTIFIED_100=false. |
| T-E76 | `pytest tests/test_e2e293_capture_inventory.py` + live `scripts/run_live293_capture_audit.py` | 4 couches capture ; chat≠stored ; MCP thinking fields ≠ ingest hook ≠ thinking_recorded ; dir AGENT_TRANSCRIPTS absent | [x] | 2026-09-09 pytest 14 passed. Live `AR-293-20260909T194104Z` SHA ×4 `05d7030` height 1133. MCP transcript 30650605 B sha256 `bacd8b4f…` 2500 champs thinking ; dir AGENT_TRANSCRIPTS absent ; socket existe ; posted_to_artcb false ; thinking_recorded false. CERTIFIED_100=false. |
