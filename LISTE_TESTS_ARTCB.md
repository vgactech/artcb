...
| T-E45 | `pytest tests/test_e2e218_domain_registry.py tests/test_e2e217_domain_genesis.py tests/test_e2e216_authz_privacy.py` | Domain Manifest + Registry : nœud héberge / fondateur possède ; export/import + hash ; pas de copie auto du corps | [x] | 2026-09-04 17+ e2e218/217 passed locally |
