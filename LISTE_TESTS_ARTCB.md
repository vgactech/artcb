...
| T-E71 | `pytest tests/test_e2e287_mac_tunnel.py` + live `scripts/run_live287_mac_tunnel.py` | RFC1918 / `.local` jamais un tunnel ; `tunnel_required` ; P2P LAN URL forbidden ; ngrok 0 tunnel ≠ PASS ; ngrok-sur-cloud-VM n’atteint pas le Mac ; CERTIFIED_100=false | [ ] | pending live |
