...
| T-E51 | `pytest tests/test_e2e263_close.py` + live `scripts/run_live263_close.py` | Complétude A→Z ; tip-attest Q=3 (4 sigs, 1086) ; evidence signée authenticated×4 ; 188 Q=3 agent+mesh ; mesh pendant partition prepared=2 ; 2 byz 0 append ; fork 1084 puis 1086×4 ; partition 2 restorée RULES=0 ; pas de PASS PBFT | [x] | 2026-09-08 `856c0ee` ×4 |
