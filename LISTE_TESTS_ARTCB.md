...
| T-E72 | `pytest tests/test_e2e289_aep.py` + live `scripts/run_live289_aep.py` | AEP : R284 6 events PARTIAL exhaustive ; SSH FAIL + COMPLETE_FOR_PROFILE ; LOSSLESS no silent truncate ; thinking jamais ; Cursor runtime NOT_PROVEN ; CERTIFIED_100=false | [ ] | pending live |
