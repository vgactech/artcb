...
| Code + tests | 55 | D-052, `certification_reason` sur `/health`, nginx conf, Replit `main`, AWS 80/443 |
| Push + PR | 70 | `cursor/artcb-me-main-nginx-ebd4` |
| Push `main` | 80 | GO opérateur (ce prompt) |
| Keep-book × 4 + nginx | 95 | voir mesures après |
| Vérif domaine | 100 | voir mesures après |
