...
def public_registry_view() -> dict[str, Any]:
    ...
    try:
        ...
        platform_binding = {
            ...
            "environment_profile": snap.get("environment_profile"),
            "maximum_supported_level": snap.get("maximum_supported_level"),
            "attested_level": snap.get("attested_level"),
            "profile_certification": snap.get("profile_certification"),
            "profile_certified_100": snap.get("profile_certified_100"),
            "l3": snap.get("l3"),
            "l4": snap.get("l4"),
